...
class Configuration:
    ...
    search_provider: Optional[str] = None  # Preferred web search provider for this run
    ...
    def from_runnable_config(
        ...
        return cls(**{k: v for k, v in values.items() if v is not None and v is not False and v != []})
